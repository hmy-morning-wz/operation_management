            ...
            <div class="content">
                <el-row class="lh40 mt10">
                    <el-col :span="24">
                        ...
                        <div class="float-left ml10">
                            <el-input v-model="searchParams.mobile" placeholder="积分帐号"></el-input>
                        </div>
                        <div class="float-left ml10">
            ...
            <div class="table">
                <div class="tableList">
                    <el-table :data="tableData">
                        ...
                        <el-table-column prop="type" label="活动类型" min-width="50" align="center"></el-table-column>
                        <el-table-column
                            label="订单时间"
                            min-width="120"
                        ...
                        <el-table-column prop="mobile" label="积分帐号" min-width="50" align="center"></el-table-column>
                        <el-table-column
                            prop="amount"
                            label="数量"
                            min-width="50"
